...
public class AddressTypeTestCase extends EntityTestCriteria {
    ...
    private AddressType createAddressType(Boolean isSave) throws Exception {
        ...
        addresstype.setAddressType("dbQAKDJnTQZrLnIwOiTjND2gcr6IPrkMIO0SF0MttqCgmvwbbU");
        addresstype.setAddressTypeDesc("TKu4kbRHWpfioWvM2lnxNgK5oLqgPOuwoz93HnIx4XUkksvQ5Q");
        addresstype.setAddressTypeIcon("87CdCYQQ2YLaCFCxA6PfSA8Rv5MTGYAUEnk3GgYJpnqdSAgO5B");
    ...
    public void test2Update() {
        try {
            ...
            addresstype.setAddressType("mVuC0K5bc8aoEhiw37BXzHhRQWiBdfT4jCoyRYsDQk2RUyttzb");
            addresstype.setVersionId(1);
            addresstype.setAddressTypeDesc("NKyyc6NGEAKvbluLoDtleH4Nd2bHHEFWHC0c1Xsn3G1jhPWKNb");
            addresstype.setAddressTypeIcon("KPErgCbKh6q7jSh4Yb6TGY4ymEziGK8R5whbCe3E3IxgEnbX53");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "addressType", "B4TDV7WAAmibVouIdN3lKsrjIrdj0hUgpEsvegASHqdPqk4rCBtqMCYm8PK0ROsSxzr6F9iw4oWhKszPKDn1Hv84d9DNNDCiljrQ4VU8nH7u6Zm18EPJqH29VaqKCkh6D"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "addressTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "addressTypeIcon", "4rw0NjiEl9VHvvwpWWclxo1am2eqr8qaJaPP12zWeUupoumYjO8oGLXIx9NEHAYawcM9nPJetixtedtPVV1l2Xa7oFxxwAF8YblHAux8vBIUDwBocyN5rOgHozgfH6XTX"));
