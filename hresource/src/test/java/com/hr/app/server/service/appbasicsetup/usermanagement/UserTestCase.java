...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelDescription("7ZiuVH8OqMM58lSAt7HOzwmd7tMwV9v0ANEcelRgpoxMXkc3aw");
        useraccesslevel.setLevelHelp("FALDw5W1HEvoZNHU6DA1wYFUG21odrH5ECXMcu3Pd2L8R80Mp8");
        useraccesslevel.setLevelIcon("G3VeZNvQsoRn07mh7dFffsTjBPeHwj9FMpYnaR1Jc0rziJP4vG");
        useraccesslevel.setLevelName("okAODmX56onfVzQYHZr2O8o2bbOF8XBDYvj5uOzzd14oGRbhKe");
        ...
        useraccessdomain.setDomainName("iuITPxc5czT5g393K92Y1M3XbpmngwKhwvjaOqErMLXOeXzawY");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("u72retBmjI3PW2sxUkefJlIdL8cchNHoOTPec6lkXuiqcNoqRD");
        useraccessdomain.setDomainIcon("NDYP8AjuQYUAl8jgySZYId39fBJ9xxw1rE5XLHMSIRo9SZvE1l");
        useraccessdomain.setDomainDescription("Iq8HzgPYIZY1xqDPRUPcxeTp4mEqIqGuTd2XyY2TwzjBogZSHN");
        ...
        User user = new User();
        user.setSessionTimeout(851);
        user.setUserAccessCode(48687);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1465380916860l));
        user.setGenTempOneTimePassword(1);
        user.setMultiFactorAuthEnabled(1);
        user.setChangePasswordNextLogin(1);
        user.setAllowMultipleLogin(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordAlgo("rgVyUasCmWhJ9CvURQ7nQ1UMVXrmHJksku3OyPeP3eS0Qr5Tp2");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1465380916913l));
        user.setIsLocked(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("PAoD14KlBm0aWPfaFxrHCDbK9snlnANp4vl8nNS3nnV9WrPhnr");
        Question question = new Question();
        question.setQuestionDetails("dQU5pvfSaa");
        question.setQuestion("fkCtFkOsUG8Xpw4EbXIPlwddDfF6qvUp4ocQwavInaVanNfUhd");
        question.setQuestionIcon("nkcbZIbYaodtEFKyYYK97h4CF9sUwFZQAwA3E1Jf31cyT0c0P5");
        ...
        passrecovery.setAnswer("Jgq8I8F3I6ppWG3CWLPiAILuuTs2ssdtBfyvdvJ95UMdbYXjHG");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setPassword("vsKCu26rk1pHQRkkXPtuS7sZV09CrxSQ3o1sXUIoaZeUOgky5e");
        userdata.setOneTimePassword("2hmeK570KDIwFgn7stCphoK46wjaeiHi");
        userdata.setPassword("r86wg8881bx7iAX3d7GsyI6ITNPaL9xz6bu85dGBYKlLzeOG9A");
        userdata.setOneTimePassword("oQxi2QtbC2EGljn02eIhh1yKjNRjZLzy");
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(11);
        userdata.setLast5Passwords("NZIbsOR2R5w3FrP3lvXfLMtVQDooLqGvRzI2YRLcORPS1OvQiY");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465380917099l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 108817));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "KULjN41zQMbX1P730p9XLUwOu8QUJbNJwaFpUJGgM1v6txIzJKzcnyykwfiAgkNlM"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4967));
