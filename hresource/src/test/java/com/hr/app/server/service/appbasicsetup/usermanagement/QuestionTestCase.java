...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("TUol93eZXV");
        question.setQuestion("IHbdomG0C4vWndkZWDxi4CsPI13ctJu1TGe1D12T0j145CvwuE");
        question.setQuestionIcon("Kx9kn0nwPGnERSdeus65A0KMpF670cj75ATOiCkwVqsEF3IIkB");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("LNtL5w2ht7");
            question.setQuestion("eHsRtfdjcQ33k1bCaNnEkf88DaCRIh82gxWbq8IP0ulNy298Y7");
            question.setQuestionIcon("MLJWqi1lJayVTyKC3kvpYTLrrYTWtbved5jWOyboTlZLvftfEH");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "AQTJ2vtePoozTDSQszYE5CG6Sw8CxBk93Oy9GJuoDNguL6kP60gjEn5j3NND4leHv"));
