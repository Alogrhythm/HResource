Ext.define('Hresource.hresource.web.com.hr.controller.humanresourceboundedcontext.employee.JobTypeMainController', {
     extend: 'Hresource.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.JobTypeMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#JobTypeTree');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#JobTypeForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#JobTypeGrid');
               var tree = this.view.down('#JobTypeTree');
               if (method == 'PUT') {
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#JobTypeForm');
          var grid = this.view.down('#JobTypeGrid');
          var tree = this.view.down('#JobTypeTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#JobTypeGrid');
               ...
               var formPanel = this.getView().up().down('#JobTypeForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var data = this.findRecordById(this.view.restURL, jsonData);
          var treePanel = this.view.up().up().down('#JobTypeTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#JobTypeForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#JobTypeGrid').store;
          gridStore.removeAll();
