 ...
 */
Ext.define('Hresource.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Hresource.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Hresource.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Hresource.view.login.SessionLogin').center();
