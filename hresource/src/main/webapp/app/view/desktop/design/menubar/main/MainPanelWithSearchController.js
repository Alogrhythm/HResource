Ext.define('Hresource.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Hresource.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Hresource.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Hresource.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Hresource.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Hresource.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Hresource.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Hresource.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
