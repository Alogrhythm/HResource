Ext.define('Hresource.view.desktop.design.menubar.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Hresource.view.desktop.design.menubar.main.MainPanelController','Hresource.view.desktop.design.menubar.menu.AppMenuBar'],
    userinfo:{},
    id:'mainPanel',
