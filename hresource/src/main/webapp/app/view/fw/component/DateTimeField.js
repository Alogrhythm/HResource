 ...
 */
Ext.define('Hresource.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Hresource.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Hresource.view.fw.component.DateTimePicker(o);
    },
