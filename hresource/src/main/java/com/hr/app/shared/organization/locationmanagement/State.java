...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "State", complexity = Complexity.LOW)
...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.locationmanagement.State other = (com.hr.app.shared.organization.locationmanagement.State) obj;
            if (stateId == null) {
                return false;
