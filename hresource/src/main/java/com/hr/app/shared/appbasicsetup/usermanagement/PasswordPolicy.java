...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "PasswordPolicy", complexity = Complexity.LOW)
...
public class PasswordPolicy implements Serializable, CommonEntityInterface, PasswordPolicyInterface, Comparator<PasswordPolicy> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.usermanagement.PasswordPolicy other = (com.hr.app.shared.appbasicsetup.usermanagement.PasswordPolicy) obj;
            if (policyId == null) {
                return false;
