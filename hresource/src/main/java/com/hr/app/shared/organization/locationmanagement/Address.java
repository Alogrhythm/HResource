...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Address", complexity = Complexity.LOW)
...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.locationmanagement.Address other = (com.hr.app.shared.organization.locationmanagement.Address) obj;
            if (addressId == null) {
                return false;
