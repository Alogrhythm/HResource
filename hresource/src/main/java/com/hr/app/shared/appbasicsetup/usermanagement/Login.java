...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Login", complexity = Complexity.LOW)
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.usermanagement.Login other = (com.hr.app.shared.appbasicsetup.usermanagement.Login) obj;
            if (loginPk == null) {
                return false;
