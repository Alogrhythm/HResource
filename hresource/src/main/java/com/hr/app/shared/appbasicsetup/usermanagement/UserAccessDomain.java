...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "UserAccessDomain", complexity = Complexity.LOW)
...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain other = (com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
