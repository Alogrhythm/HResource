...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "CommunicationData", complexity = Complexity.LOW)
...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.contactmanagement.CommunicationData other = (com.hr.app.shared.organization.contactmanagement.CommunicationData) obj;
            if (commDataId == null) {
                return false;
