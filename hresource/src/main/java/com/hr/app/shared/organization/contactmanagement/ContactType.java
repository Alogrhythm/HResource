...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "ContactType", complexity = Complexity.LOW)
...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.contactmanagement.ContactType other = (com.hr.app.shared.organization.contactmanagement.ContactType) obj;
            if (contactTypeId == null) {
                return false;
