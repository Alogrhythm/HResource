...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Question", complexity = Complexity.LOW)
...
public class Question implements Serializable, CommonEntityInterface, Comparator<Question> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.usermanagement.Question other = (com.hr.app.shared.appbasicsetup.usermanagement.Question) obj;
            if (questionId == null) {
                return false;
