package com.hr.app.shared.appbasicsetup.userrolemanagement;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Roles", complexity = Complexity.LOW)
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<com.hr.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.userrolemanagement.Roles other = (com.hr.app.shared.appbasicsetup.userrolemanagement.Roles) obj;
            if (roleId == null) {
                return false;
