...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "CommunicationType", complexity = Complexity.LOW)
...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.contactmanagement.CommunicationType other = (com.hr.app.shared.organization.contactmanagement.CommunicationType) obj;
            if (commType == null) {
                return false;
