package com.hr.app.shared.appbasicsetup.usermanagement;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "User", complexity = Complexity.LOW)
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<com.hr.app.shared.appbasicsetup.usermanagement.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.usermanagement.User other = (com.hr.app.shared.appbasicsetup.usermanagement.User) obj;
            if (userId == null) {
                return false;
