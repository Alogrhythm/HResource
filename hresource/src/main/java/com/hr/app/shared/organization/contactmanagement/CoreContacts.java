package com.hr.app.shared.organization.contactmanagement;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "CoreContacts", complexity = Complexity.LOW)
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<com.hr.app.shared.organization.contactmanagement.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<com.hr.app.shared.organization.locationmanagement.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.contactmanagement.CoreContacts other = (com.hr.app.shared.organization.contactmanagement.CoreContacts) obj;
            if (contactId == null) {
                return false;
