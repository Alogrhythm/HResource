...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "CommunicationGroup", complexity = Complexity.LOW)
...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.contactmanagement.CommunicationGroup other = (com.hr.app.shared.organization.contactmanagement.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
