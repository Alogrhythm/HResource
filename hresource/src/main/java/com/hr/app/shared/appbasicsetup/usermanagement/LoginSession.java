...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "LoginSession", complexity = Complexity.LOW)
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.usermanagement.LoginSession other = (com.hr.app.shared.appbasicsetup.usermanagement.LoginSession) obj;
            if (appSessionId == null) {
                return false;
