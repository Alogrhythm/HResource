...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Country", complexity = Complexity.LOW)
...
public class Country implements Serializable, CommonEntityInterface, Comparator<Country> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.locationmanagement.Country other = (com.hr.app.shared.organization.locationmanagement.Country) obj;
            if (countryId == null) {
                return false;
