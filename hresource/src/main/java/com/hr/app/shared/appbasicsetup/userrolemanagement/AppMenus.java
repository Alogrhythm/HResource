...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus other = (com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus) obj;
            if (menuId == null) {
                return false;
