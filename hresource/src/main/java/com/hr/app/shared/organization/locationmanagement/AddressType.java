package com.hr.app.shared.organization.locationmanagement;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "AddressType", complexity = Complexity.LOW)
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.locationmanagement.AddressType other = (com.hr.app.shared.organization.locationmanagement.AddressType) obj;
            if (addressTypeId == null) {
                return false;
