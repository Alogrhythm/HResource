...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "SessionData", complexity = Complexity.LOW)
...
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.appbasicsetup.usermanagement.SessionData other = (com.hr.app.shared.appbasicsetup.usermanagement.SessionData) obj;
            if (dataId == null) {
                return false;
