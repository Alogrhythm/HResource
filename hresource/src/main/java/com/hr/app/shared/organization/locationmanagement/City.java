...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "City", complexity = Complexity.LOW)
...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.locationmanagement.City other = (com.hr.app.shared.organization.locationmanagement.City) obj;
            if (cityId == null) {
                return false;
