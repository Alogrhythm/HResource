...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Timezone", complexity = Complexity.LOW)
...
public class Timezone implements Serializable, CommonEntityInterface, TimeZoneInterface, Comparator<Timezone> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hr.app.shared.organization.locationmanagement.Timezone other = (com.hr.app.shared.organization.locationmanagement.Timezone) obj;
            if (timeZoneId == null) {
                return false;
