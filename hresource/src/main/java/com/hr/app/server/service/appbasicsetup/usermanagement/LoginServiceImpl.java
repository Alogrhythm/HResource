...
public class LoginServiceImpl extends LoginService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.Login> lstlogin = loginrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByContactId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.hr.app.shared.appbasicsetup.usermanagement.Login> lstlogin = loginrepo.findByContactId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
    ...
    public HttpEntity<ResponseBean> findByUserId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.hr.app.shared.appbasicsetup.usermanagement.Login> lstlogin = loginrepo.findByUserId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Login"));
        responseBean.add("data", lstlogin);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.hr.app.shared.appbasicsetup.usermanagement.Login lstlogin = loginrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Login"));
        responseBean.add("data", lstlogin);
    ...
    public HttpEntity<ResponseBean> FindUnMappedUser() throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.Login> lstlogin = loginrepo.FindUnMappedUser();
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Login"));
        responseBean.add("data", lstlogin);
    ...
    public HttpEntity<ResponseBean> FindMappedUser() throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.Login> lstlogin = loginrepo.FindMappedUser();
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Login"));
        responseBean.add("data", lstlogin);
