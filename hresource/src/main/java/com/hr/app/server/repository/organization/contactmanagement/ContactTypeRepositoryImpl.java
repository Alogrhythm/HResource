...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for ContactType Master table Entity", complexity = Complexity.LOW)
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public List<ContactType> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.contactmanagement.ContactType> query = emanager.createQuery("select u from ContactType u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<ContactType> save(List<ContactType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.contactmanagement.ContactType obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.contactmanagement.ContactType s = emanager.find(com.hr.app.shared.organization.contactmanagement.ContactType.class, id);
        emanager.remove(s);
    ...
    public ContactType findById(String contactTypeId) throws Exception {
        ...
        com.hr.app.shared.organization.contactmanagement.ContactType listOfContactType = (com.hr.app.shared.organization.contactmanagement.ContactType) query.getSingleResult();
