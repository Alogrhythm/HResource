...
import com.hr.app.server.businessservice.appbasicsetup.userrolemanagement.RolesBusinessService;
...
public class RolesServiceImpl extends RolesService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.appbasicsetup.userrolemanagement.Roles> lstroles = rolesrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.userrolemanagement.Roles lstroles = rolesrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSRM224990200");
