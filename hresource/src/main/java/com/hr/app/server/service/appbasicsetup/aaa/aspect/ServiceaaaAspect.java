package com.hr.app.server.service.appbasicsetup.aaa.aspect;
...
public class ServiceaaaAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.service.appbasicsetup.aaa..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appbasicsetup.aaa..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appbasicsetup.aaa..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appbasicsetup.aaa..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appbasicsetup.aaa..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appbasicsetup.aaa..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appbasicsetup.aaa..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
