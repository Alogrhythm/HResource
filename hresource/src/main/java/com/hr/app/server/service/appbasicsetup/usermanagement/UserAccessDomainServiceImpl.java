...
public class UserAccessDomainServiceImpl extends UserAccessDomainService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain> lstuseraccessdomain = userAccessDomainrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain lstuseraccessdomain = userAccessDomainrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
