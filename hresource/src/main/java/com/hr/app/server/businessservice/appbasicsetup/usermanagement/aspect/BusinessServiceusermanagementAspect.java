package com.hr.app.server.businessservice.appbasicsetup.usermanagement.aspect;
...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.businessservice.appbasicsetup.usermanagement..*(..))")
