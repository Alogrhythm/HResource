...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for Title Master table Entity", complexity = Complexity.LOW)
public class TitleRepositoryImpl extends SearchInterfaceImpl implements TitleRepository<Title> {
    ...
    public List<Title> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.contactmanagement.Title> query = emanager.createQuery("select u from Title u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Title> save(List<Title> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.contactmanagement.Title obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.contactmanagement.Title s = emanager.find(com.hr.app.shared.organization.contactmanagement.Title.class, id);
        emanager.remove(s);
    ...
    public Title findById(String titleId) throws Exception {
        ...
        com.hr.app.shared.organization.contactmanagement.Title listOfTitle = (com.hr.app.shared.organization.contactmanagement.Title) query.getSingleResult();
