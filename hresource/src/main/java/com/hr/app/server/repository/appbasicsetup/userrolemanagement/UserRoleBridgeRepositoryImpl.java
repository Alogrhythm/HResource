...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for UserRoleBridge Transaction table", complexity = Complexity.MEDIUM)
public class UserRoleBridgeRepositoryImpl extends SearchInterfaceImpl implements UserRoleBridgeRepository<UserRoleBridge> {
    ...
    public List<UserRoleBridge> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> query = emanager.createQuery("select u from UserRoleBridge u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<UserRoleBridge> save(List<UserRoleBridge> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge s = emanager.find(com.hr.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge.class, id);
        emanager.remove(s);
    ...
    public List<UserRoleBridge> findByRoleId(String roleId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> listOfUserRoleBridge = query.getResultList();
    ...
    public UserRoleBridge findById(String roleUserMapId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge listOfUserRoleBridge = (com.hr.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge) query.getSingleResult();
