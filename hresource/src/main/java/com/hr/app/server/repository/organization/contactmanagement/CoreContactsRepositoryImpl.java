...
import com.hr.app.server.repository.core.SearchInterfaceImpl;
...
public class CoreContactsRepositoryImpl extends SearchInterfaceImpl implements CoreContactsRepository<CoreContacts> {
    ...
    public List<CoreContacts> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.contactmanagement.CoreContacts> query = emanager.createQuery("select u from CoreContacts u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public CoreContacts save(CoreContacts entity) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        java.util.List<com.hr.app.shared.organization.contactmanagement.CommunicationData> communicationdata = new java.util.ArrayList<com.hr.app.shared.organization.contactmanagement.CommunicationData>();
        for (java.util.Iterator iterator = entity.getCommunicationData().iterator(); iterator.hasNext(); ) {
            com.hr.app.shared.organization.contactmanagement.CommunicationData childEntity = (com.hr.app.shared.organization.contactmanagement.CommunicationData) iterator.next();
            if (childEntity.getPrimaryKey() != null) {
                com.hr.app.shared.organization.contactmanagement.CommunicationData ans = emanager.find(CommunicationData.class, childEntity.getPrimaryKey());
                communicationdata.add(ans);
            } else {
                communicationdata.add(childEntity);
            }
        }
        java.util.List<com.hr.app.shared.organization.locationmanagement.Address> address = new java.util.ArrayList<com.hr.app.shared.organization.locationmanagement.Address>();
        for (java.util.Iterator iterator = entity.getAddress().iterator(); iterator.hasNext(); ) {
            com.hr.app.shared.organization.locationmanagement.Address childEntity = (com.hr.app.shared.organization.locationmanagement.Address) iterator.next();
            if (childEntity.getPrimaryKey() != null) {
                com.hr.app.shared.organization.locationmanagement.Address ans = emanager.find(Address.class, childEntity.getPrimaryKey());
                address.add(ans);
            } else {
    ...
    public List<CoreContacts> save(List<CoreContacts> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.contactmanagement.CoreContacts obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.contactmanagement.CoreContacts s = emanager.find(com.hr.app.shared.organization.contactmanagement.CoreContacts.class, id);
        emanager.remove(s);
    ...
    public void deleteCommunicationData(List<CommunicationData> communicationdata) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (com.hr.app.shared.organization.contactmanagement.CommunicationData _communicationdata : communicationdata) {
            com.hr.app.shared.organization.contactmanagement.CommunicationData s = emanager.find(com.hr.app.shared.organization.contactmanagement.CommunicationData.class, _communicationdata.getCommDataId());
            emanager.remove(s);
        }
    }
    ...
    public void deleteAddress(List<Address> address) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (com.hr.app.shared.organization.locationmanagement.Address _address : address) {
            com.hr.app.shared.organization.locationmanagement.Address s = emanager.find(com.hr.app.shared.organization.locationmanagement.Address.class, _address.getAddressId());
            emanager.remove(s);
        }
    }
    ...
    public List<CoreContacts> findByTitleId(String titleId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.contactmanagement.CoreContacts> listOfCoreContacts = query.getResultList();
    ...
    public CoreContacts findById(String contactId) throws Exception {
        ...
        com.hr.app.shared.organization.contactmanagement.CoreContacts listOfCoreContacts = (com.hr.app.shared.organization.contactmanagement.CoreContacts) query.getSingleResult();
