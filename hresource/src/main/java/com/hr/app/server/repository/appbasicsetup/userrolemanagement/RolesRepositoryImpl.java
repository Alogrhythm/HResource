...
public class RolesRepositoryImpl extends SearchInterfaceImpl implements RolesRepository<Roles> {
    ...
    public List<Roles> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.userrolemanagement.Roles> query = emanager.createQuery("select u from Roles u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Roles> save(List<Roles> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.userrolemanagement.Roles obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.userrolemanagement.Roles s = emanager.find(com.hr.app.shared.appbasicsetup.userrolemanagement.Roles.class, id);
        emanager.remove(s);
    ...
    public void deleteRoleMenuBridge(List<RoleMenuBridge> rolemenubridge) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (com.hr.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge _rolemenubridge : rolemenubridge) {
            com.hr.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge s = emanager.find(com.hr.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge.class, _rolemenubridge.getRoleMenuMapId());
            emanager.remove(s);
        }
    }
    ...
    public Roles findById(String roleId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.userrolemanagement.Roles listOfRoles = (com.hr.app.shared.appbasicsetup.userrolemanagement.Roles) query.getSingleResult();
