package com.hr.app.server.service.appinsight.health.aspect;
...
public class ServicehealthAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.service.appinsight.health..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.health..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.health..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.health..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.health..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.health..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.health..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
