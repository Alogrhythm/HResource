...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for Gender Master table Entity", complexity = Complexity.LOW)
public class GenderRepositoryImpl extends SearchInterfaceImpl implements GenderRepository<Gender> {
    ...
    public List<Gender> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.contactmanagement.Gender> query = emanager.createQuery("select u from Gender u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Gender> save(List<Gender> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.contactmanagement.Gender obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.contactmanagement.Gender s = emanager.find(com.hr.app.shared.organization.contactmanagement.Gender.class, id);
        emanager.remove(s);
    ...
    public Gender findById(String genderId) throws Exception {
        ...
        com.hr.app.shared.organization.contactmanagement.Gender listOfGender = (com.hr.app.shared.organization.contactmanagement.Gender) query.getSingleResult();
