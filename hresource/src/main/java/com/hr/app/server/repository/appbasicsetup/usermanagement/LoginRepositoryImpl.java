...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for Login Transaction table", complexity = Complexity.MEDIUM)
public class LoginRepositoryImpl extends SearchInterfaceImpl implements LoginRepository<Login> {
    ...
    public List<Login> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.Login> query = emanager.createQuery("select u from Login u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Login> save(List<Login> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.usermanagement.Login obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.Login s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.Login.class, id);
        emanager.remove(s);
    ...
    public List<Login> findByContactId(String contactId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.Login> listOfLogin = query.getResultList();
    ...
    public Login findById(String loginPk) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.Login listOfLogin = (com.hr.app.shared.appbasicsetup.usermanagement.Login) query.getSingleResult();
