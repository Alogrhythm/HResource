...
public class UserRepositoryImpl extends SearchInterfaceImpl implements UserRepository<User> {
    ...
    public List<User> findAll() throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.User> query = emanager.createQuery("select u from User u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<User> save(List<User> entity) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.usermanagement.User obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.User s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.User.class, id);
        emanager.remove(s);
    ...
    public void deletePassRecovery(List<PassRecovery> passrecovery) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (com.hr.app.shared.appbasicsetup.usermanagement.PassRecovery _passrecovery : passrecovery) {
            com.hr.app.shared.appbasicsetup.usermanagement.PassRecovery s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.PassRecovery.class, _passrecovery.getPassRecoveryId());
            emanager.remove(s);
        }
    }
    ...
    public List<User> findByUserAccessLevelId(String userAccessLevelId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.User> listOfUser = query.getResultList();
    ...
    public User findById(String userId) throws Exception {
        ...
        javax.persistence.Query query = emanager.createNamedQuery("User.findById");
        query.setParameter("userId", userId);
        com.hr.app.shared.appbasicsetup.usermanagement.User listOfUser = (com.hr.app.shared.appbasicsetup.usermanagement.User) query.getSingleResult();
