package com.hr.app.server.businessservice.organization.contactmanagement.aspect;
...
public class BusinessServicecontactmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.businessservice.organization.contactmanagement..*(..))")
