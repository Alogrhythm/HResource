...
public class CommunicationGroupServiceImpl extends CommunicationGroupService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.organization.contactmanagement.CommunicationGroup> lstcommunicationgroup = communicationGrouprepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.hr.app.shared.organization.contactmanagement.CommunicationGroup lstcommunicationgroup = communicationGrouprepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
