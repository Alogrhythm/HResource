...
import com.hr.app.server.businessservice.organization.contactmanagement.CoreContactsBusinessService;
...
@RestController
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Service for CoreContacts Transaction table", complexity = Complexity.MEDIUM)
...
public class CoreContactsServiceImpl extends CoreContactsService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.organization.contactmanagement.CoreContacts> lstcorecontacts = coreContactsrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByTitleId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.hr.app.shared.organization.contactmanagement.CoreContacts> lstcorecontacts = coreContactsrepo.findByTitleId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
    ...
    public HttpEntity<ResponseBean> findByNativeLanguageCode(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.hr.app.shared.organization.contactmanagement.CoreContacts> lstcorecontacts = coreContactsrepo.findByNativeLanguageCode((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
    ...
    public HttpEntity<ResponseBean> findByGenderId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.hr.app.shared.organization.contactmanagement.CoreContacts> lstcorecontacts = coreContactsrepo.findByGenderId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
    ...
    public HttpEntity<ResponseBean> findByTimeZoneId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.hr.app.shared.organization.contactmanagement.CoreContacts> lstcorecontacts = coreContactsrepo.findByTimeZoneId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.hr.app.shared.organization.contactmanagement.CoreContacts lstcorecontacts = coreContactsrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
