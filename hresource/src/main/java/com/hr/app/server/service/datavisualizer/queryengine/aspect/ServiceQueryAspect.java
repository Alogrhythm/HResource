package com.hr.app.server.service.datavisualizer.queryengine.aspect;
...
public class ServiceQueryAspect extends ServiceAspect {
    ...
    public Object aroundAdvice1(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            Log.out.println(appAlarm.getAlarmID(), runtimeLogInfoHelper.getRequestHeaderBean(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), proceedingJoinPoint.getSignature().getName(), e.getMessage());
