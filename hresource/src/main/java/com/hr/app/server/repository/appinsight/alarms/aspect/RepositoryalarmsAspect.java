package com.hr.app.server.repository.appinsight.alarms.aspect;
...
public class RepositoryalarmsAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.repository.appinsight.alarms..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.alarms..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.alarms..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.alarms..find*(..)) && ! alarmRepofindOperation()")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.alarms..get*(..)) && ! alarmRepofindOperation()")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.alarms..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation() && ! alarmRepofindOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.alarms.ArtLogAlarmRepository..getVersionNumber(..)) || execution(* com.hr.app.server.repository.appinsight.alarms.ArtLogAlarmRepository..getAlarmDataByType(..))")
