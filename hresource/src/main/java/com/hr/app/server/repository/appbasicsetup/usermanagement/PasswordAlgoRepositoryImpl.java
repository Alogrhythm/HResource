...
public class PasswordAlgoRepositoryImpl extends SearchInterfaceImpl implements PasswordAlgoRepository<PasswordAlgo> {
    ...
    public List<PasswordAlgo> save(List<PasswordAlgo> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.usermanagement.PasswordAlgo obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.PasswordAlgo s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.PasswordAlgo.class, id);
        emanager.remove(s);
    ...
    public PasswordAlgo findById(String algoId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.PasswordAlgo listOfPasswordAlgo = (com.hr.app.shared.appbasicsetup.usermanagement.PasswordAlgo) query.getSingleResult();
