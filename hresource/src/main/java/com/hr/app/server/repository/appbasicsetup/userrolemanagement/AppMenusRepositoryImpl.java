...
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus s = emanager.find(com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus.class, id);
        emanager.remove(s);
    ...
    public AppMenus findById(String menuId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus listOfAppMenus = (com.hr.app.shared.appbasicsetup.userrolemanagement.AppMenus) query.getSingleResult();
