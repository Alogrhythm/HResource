...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for UserAccessLevel Master table Entity", complexity = Complexity.LOW)
public class UserAccessLevelRepositoryImpl extends SearchInterfaceImpl implements UserAccessLevelRepository<UserAccessLevel> {
    ...
    public List<UserAccessLevel> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel> query = emanager.createQuery("select u from UserAccessLevel u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<UserAccessLevel> save(List<UserAccessLevel> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel.class, id);
        emanager.remove(s);
    ...
    public UserAccessLevel findById(String userAccessLevelId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel listOfUserAccessLevel = (com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel) query.getSingleResult();
