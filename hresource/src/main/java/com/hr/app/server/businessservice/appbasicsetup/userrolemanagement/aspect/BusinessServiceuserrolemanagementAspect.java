package com.hr.app.server.businessservice.appbasicsetup.userrolemanagement.aspect;
...
public class BusinessServiceuserrolemanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.businessservice.appbasicsetup.userrolemanagement..*(..))")
