package com.hr.app.server.repository.appbasicsetup.userrolemanagement.aspect;
...
public class RepositoryuserrolemanagementAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.userrolemanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.userrolemanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.userrolemanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.userrolemanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.userrolemanagement..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.userrolemanagement..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
