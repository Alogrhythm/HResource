package com.hr.app.server.businessservice.appinsight.alarms.aspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
