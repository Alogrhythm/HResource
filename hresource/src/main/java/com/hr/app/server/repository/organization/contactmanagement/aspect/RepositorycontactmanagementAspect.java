package com.hr.app.server.repository.organization.contactmanagement.aspect;
...
public class RepositorycontactmanagementAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.repository.organization.contactmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.organization.contactmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.organization.contactmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.organization.contactmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.organization.contactmanagement..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.organization.contactmanagement..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
