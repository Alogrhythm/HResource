package com.hr.app.server.service.organization.locationmanagement.aspect;
...
public class ServicelocationmanagementAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.service.organization.locationmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.organization.locationmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.organization.locationmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.organization.locationmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.organization.locationmanagement..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.organization.locationmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.organization.locationmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
