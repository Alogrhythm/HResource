...
public class PasswordPolicyRepositoryImpl extends SearchInterfaceImpl implements PasswordPolicyRepository<PasswordPolicy> {
    ...
    public List<PasswordPolicy> save(List<PasswordPolicy> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.usermanagement.PasswordPolicy obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.PasswordPolicy s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.PasswordPolicy.class, id);
        emanager.remove(s);
    ...
    public PasswordPolicy findById(String policyId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.PasswordPolicy listOfPasswordPolicy = (com.hr.app.shared.appbasicsetup.usermanagement.PasswordPolicy) query.getSingleResult();
