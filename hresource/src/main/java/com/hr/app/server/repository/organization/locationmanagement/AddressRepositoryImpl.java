...
public class AddressRepositoryImpl extends SearchInterfaceImpl implements AddressRepository<Address> {
    ...
    public List<Address> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.Address> query = emanager.createQuery("select u from Address u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Address> save(List<Address> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.locationmanagement.Address obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.locationmanagement.Address s = emanager.find(com.hr.app.shared.organization.locationmanagement.Address.class, id);
        emanager.remove(s);
    ...
    public List<Address> findByAddressTypeId(String addressTypeId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.Address> listOfAddress = query.getResultList();
    ...
    public Address findById(String addressId) throws Exception {
        ...
        com.hr.app.shared.organization.locationmanagement.Address listOfAddress = (com.hr.app.shared.organization.locationmanagement.Address) query.getSingleResult();
