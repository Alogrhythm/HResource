...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for Timezone Master table Entity", complexity = Complexity.LOW)
public class TimezoneRepositoryImpl extends SearchInterfaceImpl implements TimezoneRepository<Timezone> {
    ...
    public List<Timezone> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.Timezone> query = emanager.createQuery("select u from Timezone u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Timezone> save(List<Timezone> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.locationmanagement.Timezone obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.locationmanagement.Timezone s = emanager.find(com.hr.app.shared.organization.locationmanagement.Timezone.class, id);
        emanager.remove(s);
    ...
    public Timezone findById(String timeZoneId) throws Exception {
        ...
        com.hr.app.shared.organization.locationmanagement.Timezone listOfTimezone = (com.hr.app.shared.organization.locationmanagement.Timezone) query.getSingleResult();
