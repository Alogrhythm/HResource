...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for Country Master table Entity", complexity = Complexity.LOW)
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Country> save(List<Country> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.locationmanagement.Country obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.locationmanagement.Country s = emanager.find(com.hr.app.shared.organization.locationmanagement.Country.class, id);
        emanager.remove(s);
    ...
    public Country findById(String countryId) throws Exception {
        ...
        com.hr.app.shared.organization.locationmanagement.Country listOfCountry = (com.hr.app.shared.organization.locationmanagement.Country) query.getSingleResult();
