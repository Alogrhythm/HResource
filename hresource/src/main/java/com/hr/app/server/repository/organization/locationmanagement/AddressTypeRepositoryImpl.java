...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for AddressType Master table Entity", complexity = Complexity.LOW)
public class AddressTypeRepositoryImpl extends SearchInterfaceImpl implements AddressTypeRepository<AddressType> {
    ...
    public List<AddressType> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.AddressType> query = emanager.createQuery("select u from AddressType u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<AddressType> save(List<AddressType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.locationmanagement.AddressType obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.locationmanagement.AddressType s = emanager.find(com.hr.app.shared.organization.locationmanagement.AddressType.class, id);
        emanager.remove(s);
    ...
    public AddressType findById(String addressTypeId) throws Exception {
        ...
        com.hr.app.shared.organization.locationmanagement.AddressType listOfAddressType = (com.hr.app.shared.organization.locationmanagement.AddressType) query.getSingleResult();
