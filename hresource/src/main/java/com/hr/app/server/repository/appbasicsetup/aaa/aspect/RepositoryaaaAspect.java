package com.hr.app.server.repository.appbasicsetup.aaa.aspect;
...
public class RepositoryaaaAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.aaa..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.aaa..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.aaa..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.aaa..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.aaa..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appbasicsetup.aaa..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
