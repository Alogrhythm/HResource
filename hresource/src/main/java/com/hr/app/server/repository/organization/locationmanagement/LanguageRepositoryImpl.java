...
public class LanguageRepositoryImpl extends SearchInterfaceImpl implements LanguageRepository<Language> {
    ...
    public List<Language> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.Language> query = emanager.createQuery("select u from Language u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Language> save(List<Language> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.locationmanagement.Language obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.locationmanagement.Language s = emanager.find(com.hr.app.shared.organization.locationmanagement.Language.class, id);
        emanager.remove(s);
    ...
    public Language findById(String languageId) throws Exception {
        ...
        com.hr.app.shared.organization.locationmanagement.Language listOfLanguage = (com.hr.app.shared.organization.locationmanagement.Language) query.getSingleResult();
