package com.hr.app.server.businessservice.humanresourceboundedcontext.attendance.aspect;
import com.hr.app.server.businessservice.aspect.BusinessAspect;
...
@Aspect
@Component
public class BusinessServiceattendanceAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.businessservice.humanresourceboundedcontext.attendance..*(..))")
    ...
    public Object aroundfindAll(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object object = null;
        try {
            Log.out.println("HREAT217100100", runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), joinPoint.getSignature().getDeclaringTypeName() + ":" + joinPoint.getSignature().getName());
            ...
            Log.out.println("HREAT227100100", runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName());
        } catch (Exception e) {
