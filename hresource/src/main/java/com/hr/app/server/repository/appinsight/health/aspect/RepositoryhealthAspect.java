package com.hr.app.server.repository.appinsight.health.aspect;
...
public class RepositoryhealthAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.repository.appinsight.health..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.health..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.health..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.health..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.health..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.repository.appinsight.health..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
