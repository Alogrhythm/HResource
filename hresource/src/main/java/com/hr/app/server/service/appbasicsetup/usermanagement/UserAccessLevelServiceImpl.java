...
public class UserAccessLevelServiceImpl extends UserAccessLevelService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel> lstuseraccesslevel = userAccessLevelrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.UserAccessLevel lstuseraccesslevel = userAccessLevelrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
