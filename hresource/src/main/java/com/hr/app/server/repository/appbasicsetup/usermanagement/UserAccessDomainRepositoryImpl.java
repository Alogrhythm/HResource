...
public class UserAccessDomainRepositoryImpl extends SearchInterfaceImpl implements UserAccessDomainRepository<UserAccessDomain> {
    ...
    public List<UserAccessDomain> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain> query = emanager.createQuery("select u from UserAccessDomain u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<UserAccessDomain> save(List<UserAccessDomain> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain.class, id);
        emanager.remove(s);
    ...
    public UserAccessDomain findById(String userAccessDomainId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain listOfUserAccessDomain = (com.hr.app.shared.appbasicsetup.usermanagement.UserAccessDomain) query.getSingleResult();
