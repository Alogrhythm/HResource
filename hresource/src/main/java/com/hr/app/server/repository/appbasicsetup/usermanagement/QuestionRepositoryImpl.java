...
public class QuestionRepositoryImpl extends SearchInterfaceImpl implements QuestionRepository<Question> {
    ...
    public List<Question> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.appbasicsetup.usermanagement.Question> query = emanager.createQuery("select u from Question u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Question> save(List<Question> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.appbasicsetup.usermanagement.Question obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.Question s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.Question.class, id);
        emanager.remove(s);
    ...
    public Question findById(String questionId) throws Exception {
        ...
        com.hr.app.shared.appbasicsetup.usermanagement.Question listOfQuestion = (com.hr.app.shared.appbasicsetup.usermanagement.Question) query.getSingleResult();
