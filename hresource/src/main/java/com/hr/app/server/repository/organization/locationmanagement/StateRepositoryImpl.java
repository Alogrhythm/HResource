...
public class StateRepositoryImpl extends SearchInterfaceImpl implements StateRepository<State> {
    ...
    public List<State> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.State> query = emanager.createQuery("select u from State u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<State> save(List<State> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.locationmanagement.State obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.locationmanagement.State s = emanager.find(com.hr.app.shared.organization.locationmanagement.State.class, id);
        emanager.remove(s);
    ...
    public List<State> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.State> listOfState = query.getResultList();
    ...
    public State findById(String stateId) throws Exception {
        ...
        com.hr.app.shared.organization.locationmanagement.State listOfState = (com.hr.app.shared.organization.locationmanagement.State) query.getSingleResult();
