package com.hr.app.server.businessservice.organization.locationmanagement.aspect;
...
public class BusinessServicelocationmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.businessservice.organization.locationmanagement..*(..))")
