package com.hr.app.server.service.humanresourceboundedcontext.payroll.aspect;
...
@Aspect
@Component
public class ServicepayrollAspect extends ServiceAspect {
    ...
    public Object aroundAdvice1(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getAlarm("HREPR154101500");
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
    ...
    public Object aroundAdvice2Save(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        ResponseEntity<ResponseBean> responseEntity = new ResponseEntity<>(HttpStatus.OK);
        try {
            Log.out.println("HREPR114100100", runtimeLogInfoHelper.getRequestHeaderBean(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), proceedingJoinPoint.getSignature().getName(), proceedingJoinPoint.getSignature().getDeclaringTypeName() + ":" + proceedingJoinPoint.getSignature().getName());
            ...
            Log.out.println("HREPR124100100", runtimeLogInfoHelper.getRequestHeaderBean(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), proceedingJoinPoint.getSignature().getName(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), methodCallDetails.getExecution_Time());
        } catch (Exception e) {
            AppAlarm appAlarm = Log.getExceptionAlarm("HRE", "PR", EventAppLayers.WEB_SERVICE, EventAction.WRITE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
    ...
    public Object aroundAdvice2Update(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("HRE", "PR", EventAppLayers.WEB_SERVICE, EventAction.UPDATE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    public Object aroundAdvice2Delete(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("HRE", "PR", EventAppLayers.WEB_SERVICE, EventAction.DELETE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    public Object aroundAdvicefindOperation(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("HRE", "PR", EventAppLayers.WEB_SERVICE, EventAction.READ, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    public Object aroundAdvice2AllOther(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("HRE", "PR", EventAppLayers.WEB_SERVICE, EventAction.READ_WRITE_UPDATE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    @Pointcut("execution(* com.hr.app.server.service.humanresourceboundedcontext.payroll..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.humanresourceboundedcontext.payroll..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.humanresourceboundedcontext.payroll..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.humanresourceboundedcontext.payroll..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.humanresourceboundedcontext.payroll..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.humanresourceboundedcontext.payroll..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.humanresourceboundedcontext.payroll..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
