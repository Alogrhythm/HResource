...
import com.hr.app.shared.appbasicsetup.usermanagement.SessionData;
...
public class SessionDataRepositoryImpl extends SearchInterfaceImpl implements SessionDataRepository<SessionData> {
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.appbasicsetup.usermanagement.SessionData s = emanager.find(com.hr.app.shared.appbasicsetup.usermanagement.SessionData.class, id);
        emanager.remove(s);
    }
