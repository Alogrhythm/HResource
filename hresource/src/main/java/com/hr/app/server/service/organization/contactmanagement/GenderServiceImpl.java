...
public class GenderServiceImpl extends GenderService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.organization.contactmanagement.Gender> lstgender = genderrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.hr.app.shared.organization.contactmanagement.Gender lstgender = genderrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
