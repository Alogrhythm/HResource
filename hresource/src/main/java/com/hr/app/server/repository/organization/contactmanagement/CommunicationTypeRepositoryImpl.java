...
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public List<CommunicationType> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.contactmanagement.CommunicationType> query = emanager.createQuery("select u from CommunicationType u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<CommunicationType> save(List<CommunicationType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.contactmanagement.CommunicationType obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.contactmanagement.CommunicationType s = emanager.find(com.hr.app.shared.organization.contactmanagement.CommunicationType.class, id);
        emanager.remove(s);
    ...
    public List<CommunicationType> findByCommGroupId(String commGroupId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.contactmanagement.CommunicationType> listOfCommunicationType = query.getResultList();
    ...
    public CommunicationType findById(String commType) throws Exception {
        ...
        com.hr.app.shared.organization.contactmanagement.CommunicationType listOfCommunicationType = (com.hr.app.shared.organization.contactmanagement.CommunicationType) query.getSingleResult();
