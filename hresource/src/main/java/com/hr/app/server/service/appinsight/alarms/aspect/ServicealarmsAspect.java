package com.hr.app.server.service.appinsight.alarms.aspect;
...
public class ServicealarmsAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.hr.app.server.service.appinsight.alarms..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.alarms..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.alarms..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.alarms..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.alarms..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.alarms..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hr.app.server.service.appinsight.alarms..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
