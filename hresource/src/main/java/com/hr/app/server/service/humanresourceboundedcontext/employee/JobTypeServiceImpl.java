...
public class JobTypeServiceImpl extends JobTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.hr.app.shared.humanresourceboundedcontext.employee.JobType> lstjobtype = jobTyperepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.hr.app.shared.humanresourceboundedcontext.employee.JobType lstjobtype = jobTyperepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("HREEM124100200");
