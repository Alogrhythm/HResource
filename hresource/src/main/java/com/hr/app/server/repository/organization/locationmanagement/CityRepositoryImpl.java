...
public class CityRepositoryImpl extends SearchInterfaceImpl implements CityRepository<City> {
    ...
    public List<City> findAll() throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.City> query = emanager.createQuery("select u from City u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<City> save(List<City> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.hr.app.shared.organization.locationmanagement.City obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.hr.app.shared.organization.locationmanagement.City s = emanager.find(com.hr.app.shared.organization.locationmanagement.City.class, id);
        emanager.remove(s);
    ...
    public List<City> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<com.hr.app.shared.organization.locationmanagement.City> listOfCity = query.getResultList();
    ...
    public City findById(String cityId) throws Exception {
        ...
        com.hr.app.shared.organization.locationmanagement.City listOfCity = (com.hr.app.shared.organization.locationmanagement.City) query.getSingleResult();
